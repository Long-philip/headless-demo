                          ...
                          >
                            <div className="relative flex w-full flex-row justify-between px-1 py-4">
                              ...
                              <div className="flex h-16 flex-col justify-between">
                                ...
                                />
                                <div className="ml-auto flex h-9 flex-row items-center rounded-[14px] border border-neutral-200">
...
function CheckoutButton() {
  ...
  return (
    <button
      className="block w-full rounded-[14px] bg-brand p-3 text-center text-sm font-medium text-white opacity-90 hover:opacity-100"
      type="submit"
      disabled={pending}
    >
